 ...
 *
 */
public class RoleRunEvent implements IEvent {

	private static final Logger logger = Logger.getLogger(RoleRunEvent.class);
	private int mapId;

	public RoleRunEvent(int mapId) {
		this.mapId = mapId;
	}
