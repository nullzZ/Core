...
public class QuartzManager {
	 ...
	 */
	public static void addJob(String jobName, Class<?> jobClass, String time, JobDataMap jobDataMap) {
		try {
	 ...
	 *            数据
	 */
	public static void addJob(String jobName, Class<?> jobClass, Date startTime, long repeatInterval, int repeatCount,
